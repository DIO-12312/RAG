...
class JobService:
    ...
    # 按幂等键创建或复用失败 Job 的重试 Job，并返回其状态视图。
    ...
    @staticmethod
    # 将领域 Job 和 Task 转换为 RPC/application 层使用的 JobView。
