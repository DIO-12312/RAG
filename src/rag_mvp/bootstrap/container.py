...
async def build_server_container(
    ...
    try:
        ...
        source_parser = SourceParserRouter(
            ...
            pdf_header_footer_margin_ratio=settings.pdf_header_footer_margin_ratio,
            pdf_repeated_margin_min_pages=settings.pdf_repeated_margin_min_pages,
        )
        ...
        container.rag_service = RagService(
            ...
            parser_version=settings.parser_fingerprint,
